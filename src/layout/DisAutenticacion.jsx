...
const DisAutenticacion = ({ titulo, descripcion, imagenUrl, imagenAlt, children }) => {
  ...
  return (
    <div className="dis-autenticacion" style={{ backgroundColor: tema.fondo}}>
      <div className="dis-autenticacion__tarjeta" style={{ backgroundColor: tema.fondoSegundario}}>
        <div
        ...
        >
          <div className="dis-autenticacion__contenido">
            <h2 className="dis-autenticacion__titulo" style={{
            color: tema.textoSecundario,
          }}>{titulo}</h2>
            <p className="dis-autenticacion__descripcion" style={{
            color: tema.textoSecundario,
          }}>{descripcion}</p>

          <div className='dis-autenticacion__imagen-container'>
            <img src={imagenUrl} alt={imagenAlt} className="dis-autenticacion__imagen" />
            </div>
          </div>
        </div>
        <div
